...
import com.ecomapp.admin.databinding.SelectSubCategorySingleBinding

class SelectSubCatAdapter(
    myContext: Context,
    mySubCatList: ArrayList<SubCatModel>,

) : RecyclerView.Adapter<SelectSubCatAdapter.SubCatViewHolder>() {

    var context = myContext
    var subCatList = mySubCatList

    class SubCatViewHolder(subCatBinding: SelectSubCategorySingleBinding) :
        RecyclerView.ViewHolder(subCatBinding.getRoot()) {

        var subCatBinding: SelectSubCategorySingleBinding
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SubCatViewHolder {
        val binding: SelectSubCategorySingleBinding = DataBindingUtil.inflate(
            LayoutInflater.from(parent.context),
            R.layout.select_sub_category_single, parent, false
        )
    ...
    override fun onBindViewHolder(holder: SubCatViewHolder, position: Int) {
        ...
        holder.subCatBinding.checkboxSubcat.text = singleCat.subCatName
